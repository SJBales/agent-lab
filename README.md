...
This is a repo for exploring the main techniques that make agents work like tool use, memory, context, state and swarms. It's a mix of tutorial code and toy applications.
...
- dynamic_agents.ipynb --> explores the capabilities to dynamically modify agents based on the context
- email_agent.ipynb --> building an email agent that has permission-based reads of an email inbox and allows for user review of the email before it is sent
